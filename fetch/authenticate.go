...
// SignServicesRequest returns a HMAC-SHA256 string for BlueKai JSON request
func SignServicesRequest(method string, endPoint string, data string) string {
	var URL string
...
// SignTaxonomyRequest returns a HMAC-SHA256 string for BlueKai JSON request
func SignTaxonomyRequest(method string, endPoint string, data string) string {
	var URL string
